/**
 ...
 of one-letter strings representing directions to walk (eg. ['n', 's', 'w', 'e']). You know it takes you one
...
function isValidWalk(walk) {
    var sumx = 0, sumy = 0;
    walk.forEach(function (item, i, arr) {
        if (item === "n") sumx++;
        else if (item === "s") sumx--;
        else if (item === "w") sumy++;
        else if (item === "e") sumy--;
    });
    return (walk.length === 10) && (sumx === sumy) && (sumx === 0);
}
